...
function _startApolloServer() {
  _startApolloServer = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(typeDefs, resolvers) {
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            app = (0, _express["default"])(); // Our httpServer handles incoming requests to our Express app.
            // Below, we tell Apollo Server to "drain" this httpServer,
            // enabling our servers to shut down gracefully.

            httpServer = _http["default"].createServer(app); // Same ApolloServer initialization as before, plus the drain plugin
            // for our httpServer.
            ...
            server = new _apolloServerExpress.ApolloServer({
              ...
              context: function context(_ref) {
                ...
                return _objectSpread(_objectSpread({}, req), {}, {
                  userId: req ? _auth["default"].getUserId({
                    req: req
                  }) : null
                });
              }
...
_mongoose["default"].connect(_configs.urlMONGODB, {
  useNewUrlParser: true
}).then(function () {
  startApolloServer(_typeDefs["default"], _resolvers["default"]);
});
